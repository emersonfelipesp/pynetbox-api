...
class NetBoxBase:
    ...
    def _check_duplicate(self, json: dict):
        try:
            if type(self.primary_field) == list:
                search_dict: dict = {}
                ...
                duplicate = self.get(value=json.get(self.primary_field))
